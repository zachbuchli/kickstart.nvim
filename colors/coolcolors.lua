...
Group.new('Character', colors.TextColor, nil, nil)
Group.new('Number', colors.blue, nil, nil)
Group.new('Boolean', colors.orange, nil, nil)
Group.new('Float', colors.TextColor, nil, nil)
...
Group.new('Conditional', colors.TextColor, nil, nil)
Group.new('Repeat', colors.TextColor, nil, nil)
...
Group.new('PreProc', colors.TextColor, nil, nil)
Group.new('Include', colors.red, nil, nil)
Group.new('Define', colors.TextColor, nil, nil)
Group.new('Macro', colors.TextColor, nil, nil)
Group.new('PreCondit', colors.TextColor, nil, nil)

Group.new('Type', colors.blue, nil, nil)
Group.new('StorageClass', colors.TextColor, nil, nil)
Group.new('Structure', colors.TextColor, nil, nil)
Group.new('Typedef', colors.TextColor, nil, nil)
